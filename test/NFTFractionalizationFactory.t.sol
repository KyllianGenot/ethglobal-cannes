...
contract NFTFractionalizationFactoryTest is Test {
    ...
    function testOnlyOwnerCanCreateNFT() public {
        ...
        vm.expectRevert();
        factory.createFractionalizedNFT(
            TOTAL_SHARES,
            SHARE_PRICE,
            "Fractional Art #1",
            "FART1",
    ...
    function testPurchaseShares() public {
        ...
        // Verify user info
        (uint256 shareBalance, uint256 sharesPurchased, uint256 shareValue) = 
            factory.getUserNFTInfo(tokenId, user1);
    ...
    function testMultipleNFTs() public {
        ...
        // Create second NFT
        (uint256 tokenId2,) = factory.createFractionalizedNFT(
            500,
            0.002 ether,
            "Fractional Art #2",
            "FART2",
